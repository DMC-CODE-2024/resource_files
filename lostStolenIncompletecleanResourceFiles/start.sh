#!/bin/bash
set -x
module_name="lost_stolen_incomplete_clean"
main_module="utility" #keep it empty "" if there is no main module 
...
./propertiesFileChecker.sh ${APP_HOME}/${main_module}/${module_name}
